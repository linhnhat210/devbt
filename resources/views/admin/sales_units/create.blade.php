    ...
    <div class="body flex-grow-1">
        <div class="container-lg px-4">
            <div class="row mb-3 align-items-center">
                <div class="col-md-3">
                    <a href="{{ route('admin.sales_units.index') }}" type="button" class="btn btn-secondary">
            ...
            <div class="card mb-4">
                <div class="card-header">Thêm đơn vị bán hàng</div>
                <div class="card-body">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                <label for="name" class="form-label"><span class="text-danger">*</span> Tên đơn
                                    vị</label>
                                <input type="text" class="form-control" name="name" placeholder="Nhập tên đơn vị"
                                    value="{{ old('name') }}">
                                @error('name')
